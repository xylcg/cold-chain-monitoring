    ...
    samples = [
        {
            ...
            "records": [
                {"id": "tr-cc1001-001", "stage": "precool", "location": "华北中心冷库预冷区",
                 "temperature": -23.0, "humidity": 65.0, "action": "快速预冷完成",
                 "operator": "仓管员A", "device_id": "CR-HB-001",
                 "lat": 39.90, "lng": 116.40, "notes": "三文鱼入库预冷至-23℃",
                 "timestamp": (now - timedelta(hours=48)).isoformat()},
                {"id": "tr-cc1001-002", "stage": "warehouse_in", "location": "华北中心冷库",
                 "temperature": -22.5, "humidity": 68.0, "action": "入库验收",
                 "operator": "仓管员B", "device_id": "CR-HB-002",
                 "lat": 39.90, "lng": 116.40, "notes": "品质A级冷冻三文鱼，200kg",
                 "timestamp": (now - timedelta(hours=46)).isoformat()},
                {"id": "tr-cc1001-003", "stage": "warehouse_store", "location": "华北中心冷库A区冷冻库",
                 "temperature": -22.0, "humidity": 70.0, "action": "恒温存储",
                 "operator": "系统自动", "device_id": "CR-HB-002",
                 "lat": 39.90, "lng": 116.40, "notes": "冷冻存储40小时，温控稳定",
                 "timestamp": (now - timedelta(hours=30)).isoformat()},
                {"id": "tr-cc1001-004", "stage": "loading", "location": "华北中心冷库装车台",
                 "temperature": -21.0, "humidity": 72.0, "action": "装车完成",
                 "operator": "司机老王", "device_id": "VEH-COLD-01",
                 "lat": 39.90, "lng": 116.40, "notes": "冷藏车装车，开门时长2分钟",
                 "timestamp": (now - timedelta(hours=10)).isoformat()},
                {"id": "tr-cc1001-005", "stage": "transport", "location": "G2京沪高速天津段",
                 "temperature": -21.5, "humidity": 71.0, "action": "正常行驶",
                 "operator": "司机老王", "device_id": "VEH-COLD-01",
                 "lat": 39.12, "lng": 117.20, "notes": "车速80km/h，冷机正常运行",
                 "timestamp": (now - timedelta(hours=6)).isoformat()},
                {"id": "tr-cc1001-006", "stage": "transport", "location": "G18荣乌高速廊坊段",
                 "temperature": -20.8, "humidity": 73.0, "action": "正常行驶",
                 "operator": "司机老王", "device_id": "VEH-COLD-01",
                 "lat": 39.50, "lng": 116.70, "notes": "全程冷链，温度合规",
                 "timestamp": (now - timedelta(hours=3)).isoformat()},
                {"id": "tr-cc1001-007", "stage": "delivery", "location": "北京市朝阳区配送点",
                 "temperature": -20.0, "humidity": 75.0, "action": "送达验收",
                 "operator": "收件人张三", "device_id": "VEH-COLD-01",
                 "lat": 39.92, "lng": 116.46, "notes": "签收确认，货物完好",
                 "timestamp": (now - timedelta(hours=1)).isoformat()},
                {"id": "tr-cc1001-008", "stage": "signed", "location": "北京市朝阳区",
                 "temperature": -19.5, "humidity": 78.0, "action": "客户签收",
                 "operator": "张三", "device_id": "",
                 "lat": 39.92, "lng": 116.46, "notes": "客户确认收货，全程温控达标",
    ...
    for wb_id, wb_data in ws.get("waybills", {}).items():
        if wb_id not in WAYBILL_TRACE_MAP:
            ...
            TRACE_DATA[trace_code] = {
                ...
                "is_high_sensitivity": False,
                "receiver": wb_data.get("receiver", ""),
                "receiver_contact": wb_data.get("receiver_contact", ""),
